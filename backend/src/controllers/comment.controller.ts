...
export const getPostCommentsController = async (req: Request, res: Response): Promise<any> => {
...
export const addCommentController = async (req: Request, res: Response): Promise<any> => {
    const schema = z.object({
        postId: z.number(),
        content: z.string()
    });
...
export const updateCommentController = async (req: Request, res: Response): Promise<any> => {
    const schema = z.object({
        commentId: z.number(),
        content: z.string()
    });
...
export const deleteCommentController = async (req: Request, res: Response): Promise<any> => {
    const schema = z.object({
        commentId: z.number()
    });
